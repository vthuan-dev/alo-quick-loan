...
async function testExportAPI() {
  try {
    console.log('🔍 Testing Export API with debug info...');
    ...
    // Hoặc sử dụng token test
    const token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJhZG1pbiIsInVzZXJuYW1lIjoiYWRtaW4iLCJyb2xlIjoiYWRtaW4iLCJwZXJtaXNzaW9ucyI6WyIqIl0sImlhdCI6MTczNTU5NzE5MSwiZXhwIjoxNzM1NjgzNTkxfQ.Ej8Ej8Ej8Ej8Ej8Ej8Ej8Ej8Ej8Ej8Ej8Ej8Ej8Ej8';
    ...
    if (response.status === 401) {
      ...
      console.log('💡 Please get a real token from browser localStorage');
      return;
    }
